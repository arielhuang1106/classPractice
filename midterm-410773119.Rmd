...
```{r ans15}
rowSums(hwGrades[,c("hw1","hw2","Exercise3")],na.rm = T)/3 -> hwGrades$平均成績
```
...
```{r ans21}
library(dplyr)
mutate(hwSubmit$Timestamp
    Timestamp=ymd_hms(Timestamp),
    Timestamp=with_tz(Timestamp,tzone="Asia/Taipei") -> hwSubmit
```
...
difftime(deadline3,Timestamp,units="hours") -> hwSubmit3
```
